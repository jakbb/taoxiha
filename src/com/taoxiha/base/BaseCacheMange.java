...
import com.taoxiha.common.cache.redis.EntityCache;
import com.taoxiha.common.cache.redis.RedisClientSurppot;

/**
 * cache 管理抽象类
 * 
 * @ClassName: BaseCacheMange
 * @Description: TODO 完成cacheCURD
...
public abstract class BaseCacheMange<E> extends RedisClientSurppot implements EntityCache<E> {
	...
	public static final String UNIQUE_CACHE_KEY_PREFIX = BaseEntity.CACHE_APP_NAME.concat("cache-user-unique-");
	...
	/** 指定key保存对象作为value */
	public void saveEntity(String key, E entity) throws CacheAccessException {
		try {
