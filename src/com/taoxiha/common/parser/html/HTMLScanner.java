...
import com.taoxiha.common.parser.html.xercesbridge.XercesBridge;
...
//                        throw new EOFException();
     ...
     */ 
    public boolean isEncodingCompatible(final String encoding1, final String encoding2) {
     ...
     */
	public static void reduceToContent(final XMLStringBuffer buffer, final String startMarker, final String endMarker) {
		int i = 0;
		int startContent = -1;
