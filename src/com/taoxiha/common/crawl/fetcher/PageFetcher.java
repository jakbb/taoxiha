...
package com.taoxiha.common.crawl.fetcher;
...
import com.taoxiha.service.crawl.entity.Cookie;
...
public class PageFetcher extends Configurable {
	...
	public PageFetcher(CrawlConfig config) {
		...
		//config reqParams
		   Map<String,String> reqParams=config.getReqParams();
		   if(!CollectionUtils.isEmpty(reqParams)){
			   for(String key:reqParams.keySet()){
				   params.setParameter(key, reqParams.get(key));
			   }
		   }
     ...
     List<Cookie> cookies = config.getCookies();
		if(!CollectionUtils.isEmpty(cookies)){
			...
			clientCookie.setExpiryDate(DateUtils.returnToDate(cookie.getMaxAge()));
