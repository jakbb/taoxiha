...
import com.taoxiha.common.http.client.resumable.ResumableAsyncHandler;
import com.taoxiha.common.http.client.resumable.ResumableIOExceptionFilter;
import com.taoxiha.common.http.client.simple.HeaderMap;
import com.taoxiha.common.http.client.simple.SimpleAHCTransferListener;
...
public class SimpleAsyncHttpClient implements Closeable {
    ...
    private final static class ResumableBodyConsumerAsyncHandler
        ...
        public com.taoxiha.common.http.client.AsyncHandler.STATE onHeaderWriteCompleted() {
            return delegate.onHeaderWriteCompleted();
        }

        public com.taoxiha.common.http.client.AsyncHandler.STATE onContentWriteCompleted() {
            return delegate.onContentWriteCompleted();
        }

        public com.taoxiha.common.http.client.AsyncHandler.STATE onContentWriteProgress(long amount, long current, long total) {
