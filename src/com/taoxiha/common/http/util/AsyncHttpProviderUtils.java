 ...
 */
package com.taoxiha.common.http.util;
...
import com.taoxiha.common.http.client.ByteArrayPart;
import com.taoxiha.common.http.client.Cookie;
import com.taoxiha.common.http.client.FilePart;
...
import com.taoxiha.common.http.client.Part;
import com.taoxiha.common.http.client.Request;
import com.taoxiha.common.http.client.StringPart;
import com.taoxiha.common.http.multipart.ByteArrayPartSource;
import com.taoxiha.common.http.multipart.MultipartRequestEntity;
import com.taoxiha.common.http.multipart.PartSource;
...
public class AsyncHttpProviderUtils {
    ...
    public final static MultipartRequestEntity createMultipartRequestEntity(List<Part> params, FluentCaseInsensitiveStringsMap requestHeaders) throws FileNotFoundException {
        com.taoxiha.common.http.multipart.Part[] parts = new com.taoxiha.common.http.multipart.Part[params.size()];
        int i = 0;

        for (Part part : params) {
            if (part instanceof com.taoxiha.common.http.multipart.Part) {
                parts[i] = (com.taoxiha.common.http.multipart.Part) part;
            } else if (part instanceof StringPart) {
                parts[i] = new com.taoxiha.common.http.multipart.StringPart(part.getName(),
                        ((StringPart) part).getValue(),
                        ((StringPart) part).getCharset());
            } else if (part instanceof FilePart) {
                parts[i] = new com.taoxiha.common.http.multipart.FilePart(part.getName(),
