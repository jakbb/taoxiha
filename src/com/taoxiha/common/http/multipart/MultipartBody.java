...
import com.taoxiha.common.http.client.RandomAccessBody;

public class MultipartBody implements RandomAccessBody {

    private byte[] boundary;
    private long contentLength;
    private List<com.taoxiha.common.http.client.Part> parts;
    ...
    public MultipartBody(List<com.taoxiha.common.http.client.Part> parts, String contentType, String contentLength) {
    ...
    public long read(ByteBuffer buffer) throws IOException {
        try {
            ...
            while (!full && !doneWritingParts) {
                com.taoxiha.common.http.client.Part part = null;
                ...
                if (currentFileChannel != null) {
                    ...
                    startPart++;
                } else if (part instanceof com.taoxiha.common.http.client.StringPart) {
                ...
                } else if (part instanceof com.taoxiha.common.http.client.FilePart) {
                    if (fileLocation == FileLocation.NONE) {
                ...
                } else if (part instanceof com.taoxiha.common.http.client.ByteArrayPart) {
                    com.taoxiha.common.http.client.ByteArrayPart bytePart =
                            (com.taoxiha.common.http.client.ByteArrayPart) part;
    ...
    public long transferTo(long position, long count, WritableByteChannel target)
        ...
        for (com.taoxiha.common.http.client.Part part : parts) {
    ...
    private long handleClientPart(
            WritableByteChannel target, com.taoxiha.common.http.client.Part part) throws IOException {

        if (part.getClass().equals(com.taoxiha.common.http.client.StringPart.class)) {
            StringPart currentPart = generateClientStringpart(part);

            return handleStringPart(target, currentPart);
        } else if (part.getClass().equals(com.taoxiha.common.http.client.FilePart.class)) {
            FilePart filePart = generateClientFilePart(part);

            return handleFilePart(target, filePart);
        } else if (part.getClass().equals(com.taoxiha.common.http.client.ByteArrayPart.class)) {
            com.taoxiha.common.http.client.ByteArrayPart bytePart = (com.taoxiha.common.http.client.ByteArrayPart) part;
    ...
    private FilePart generateClientFilePart(com.taoxiha.common.http.client.Part part)
            throws FileNotFoundException {
        com.taoxiha.common.http.client.FilePart currentPart = (com.taoxiha.common.http.client.FilePart) part;

        FilePart filePart = new FilePart(currentPart.getName(), currentPart.getFile(), currentPart.getMimeType(), currentPart.getCharSet());
        return filePart;
    }

    private StringPart generateClientStringpart(com.taoxiha.common.http.client.Part part) {
        com.taoxiha.common.http.client.StringPart stringPart = (com.taoxiha.common.http.client.StringPart) part;
